...
const Categoery = () => {
    return (
        <section class="categories relative z-1">
            <div class="px-0.5">
                <div class="grid md:grid-cols-3 grid-cols-1 overflow-hidden">
                    <div class="col-span-2 p-1">
                        <div class="h-[101vh]" style={{ backgroundImage: 'url("https://postgraduateeducation.hms.harvard.edu/sites/g/files/mcu816/files/media/4.23.2021_Making%20Wellness%20an.jpg")', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center', filter: 'saturate(200%)' }}>
                            <div class="grid place-items-center text-center bg-gradient-to-b from-green-100 to-emerald-900 text-black hover:text-white opacity-20 hover:opacity-90 h-[100%]">
                                <div>
                    ...
                    <div class="">
                        <div class="grid grid-rows-2">
                            <div class="p-1">
                                <div class="h-[50vh]" style={{ backgroundImage: 'url("https://www.eehealth.org/-/media/images/modules/blog/posts/hdcancerdentist.jpg")', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center', filter: 'saturate(200%)' }}>
                                    <div class="grid place-items-center text-center bg-gradient-to-b from-green-100 to-emerald-900 text-black hover:text-white  opacity-20 hover:opacity-90 h-[100%]">
                                        <div>
                            ...
                            <div class="p-1">
                                <div class="h-[50vh]" style={{ backgroundImage: 'url("https://www.betterteam.com/images/dermatologist-job-description-3559x3369-20201125.jpeg?crop=21:16,smart&width=420&dpr=2")', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center', filter: 'saturate(200%)' }}>
                                    <div class="grid place-items-center text-center bg-gradient-to-b from-green-100 to-emerald-900 text-black hover:text-white opacity-20 hover:opacity-90 h-[100%]">
                                        <div>
